...
%Load the file
fname = '2021-05-22-16-17-43.bag';       % Filename
...
% % subplot(3,1,1)
% % hold on
% % plot(cmd_cora1_ts.Time-cmd_cora1_ts.Time(1),cmd_cora1_ts.Data(:,1))
% % plot(odom_cora1_ts.Time-odom_cora1_ts.Time(1),odom_cora1_ts.Data(:,7))
% % xlabel('Time [s]')
...
% % subplot(3,1,2)
% % hold on
% % plot(cmd_cora1_ts.Time-cmd_cora1_ts.Time(1),cmd_cora1_ts.Data(:,2))
% % plot(odom_cora1_ts.Time-odom_cora1_ts.Time(1),odom_cora1_ts.Data(:,9))
% % xlabel('Time [s]')
...
% % subplot(3,1,3)
% % hold on
% % plot(cmd_cora1_ts.Time-cmd_cora1_ts.Time(1),cmd_cora1_ts.Data(:,6))
% % plot(odom_cora1_ts.Time-odom_cora1_ts.Time(1),odom_cora1_ts.Data(:,7))
% % xlabel('Time [s]')
% % ylabel('X-Velocity [m/s]')
% % legend('cmd','CORA')
